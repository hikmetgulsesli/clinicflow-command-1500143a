...
- ClinicFlow Command turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser clinic operations command center app called ClinicFlow Command. It should manage patient intake, triage queue, room assignments, provider handoffs, exception alerts, reports, settings, empty/error recovery, search/filter/sort controls, and persistent local state. Use a Vite React web…
...
- Patient Operations - ClinicFlow Command
- Patient Editor - ClinicFlow Command
- Queue and Status Management - ClinicFlow Command
- Insights - ClinicFlow Command
- Settings and Preferences - ClinicFlow Command
- Empty and Error Recovery - ClinicFlow Command

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Patient Operations - ClinicFlow Command
...
SCREEN_SPEC_2:
- exact_screen_title: Patient Editor - ClinicFlow Command
...
SCREEN_SPEC_3:
- exact_screen_title: Queue and Status Management - ClinicFlow Command
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - ClinicFlow Command
...
SCREEN_SPEC_5:
- exact_screen_title: Settings and Preferences - ClinicFlow Command
...
SCREEN_SPEC_6:
- exact_screen_title: Empty and Error Recovery - ClinicFlow Command
